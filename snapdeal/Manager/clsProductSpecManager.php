...
class clsProductSpecManager{
	...
	public static function InsertProducts($ProductsObject){         
		...
		$sql="INSERT INTO `product_spec` (`id`,`product_id`, `product_spec_type`, `product_data`,`table_name`) VALUES ('".NULL ."','".safe($ProductsObject->GetProductID())."','".safe($ProductsObject->GetProductSpecType())."', '".safe($ProductsObject->GetProductData())."','".safe($ProductsObject->GetTableName())."')";  		
		//echo $sql."<br/>";
